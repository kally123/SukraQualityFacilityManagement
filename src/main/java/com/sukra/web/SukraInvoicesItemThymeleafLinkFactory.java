...
/**
 * = SukraInvoicesItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SukraInvoicesItemThymeleafController.class)
@Component
public class SukraInvoicesItemThymeleafLinkFactory implements MethodLinkFactory<SukraInvoicesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<SukraInvoicesItemThymeleafController> getControllerClass() {
        return SukraInvoicesItemThymeleafController.class;
    }
