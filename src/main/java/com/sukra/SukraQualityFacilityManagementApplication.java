...
/**
 * = SukraQualityFacilityManagementApplication
 *
 * TODO Auto-generated class documentation
 *
 */
@SpringBootApplication
public class SukraQualityFacilityManagementApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SukraQualityFacilityManagementApplication.class, args);
		openAppUrl("8080");
    }
