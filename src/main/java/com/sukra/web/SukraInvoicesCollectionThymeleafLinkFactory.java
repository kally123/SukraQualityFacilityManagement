...
/**
 * = SukraInvoicesCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SukraInvoicesCollectionThymeleafController.class)
@Component
public class SukraInvoicesCollectionThymeleafLinkFactory implements MethodLinkFactory<SukraInvoicesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<SukraInvoicesCollectionThymeleafController> getControllerClass() {
        return SukraInvoicesCollectionThymeleafController.class;
    }
